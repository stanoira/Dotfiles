...
local handlers = require("stanoira.lsp.handlers")
...
mason_lsp.setup_handlers({
    ...
    ["rust_analyzer"] = function()
        local rust_config = require("stanoira.lsp.settings.rust")
    ...
    ["sumneko_lua"] = function()
        lspconfig.sumneko_lua.setup({
            on_attach = on_attach,
            capabilities = capabilities,
            settings = require("stanoira.lsp.settings.sumneko_lua"),
        })
    end,
    ...
    ["pyright"] = function()
        lspconfig.pyright.setup({
            on_attach = on_attach,
            capabilities = capabilities,
            settings = require("stanoira.lsp.settings.pyright"),
        })
    end,
